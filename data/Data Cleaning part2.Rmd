...
orig_data <- read.csv("/Users/apple/Downloads/rstrt.csv",na.strings = c(""," "))
...
#setwd("/Users/apple/Downloads/Spr2017-proj2-grp5-master 2/data")
...
page15000<-read.csv("page7501-1500.csv")
